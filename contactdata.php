...
<head>
    <meta charset="utf-8">
    <title>DentCare - Contact Records</title>
      ...
      <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                ...
                <a href="" class="h4 text-white">Queries</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
    ...
    while ($rows = mysqli_fetch_assoc($result)) {
        echo "
            <tr class=''>
                ...
                <td>{$rows['message']}</td>
                <td>
                    <a name='' id='' class='btn btn-warning' href='replycontact.php?id={$rows['id']}' role='button'>Reply</a>
                    <a name='' id='' class='btn btn-danger' href='deletecontact.php?id={$rows['id']}' role='button'>Delete</a>
                </td>
            </tr>";
    }
